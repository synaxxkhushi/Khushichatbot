...
╔═══⋆ʟᴏᴠᴇ ᴡɪᴛʜ⋆═══╗
★ [❍─⃜͢͢༌🌸⎯꯭̽𝐒𝐘𝐍𝐀𝐗𝆺꯭𝅥༌🌸](https://t.me/synaxhere)     ★
╚═════ ⋆★⋆ ═════╝
**"""

HELP_READ = f"""**
Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/synaxhere).
